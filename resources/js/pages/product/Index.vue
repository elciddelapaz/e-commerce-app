...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="relative min-h-[100vh] flex-1 rounded-xl border border-sidebar-border/70 dark:border-sidebar-border md:min-h-min p-4">
            <Link :href="route('products.create')" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create</Link>
            ...
            <table class="table-auto border-separate border-spacing-5">
                ...
                <tr v-for="product in products.data" :key="product.id">
                    ...
                    <td>{{ product.price }}</td>
                    <td class="flex gap-1">
                        <Link :href="route('products.edit', product.id)"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit</button></Link>
